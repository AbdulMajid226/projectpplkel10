...
@section('content')
    <div class="container mx-auto px-4">
        <h1 class="text-4xl font-bold text-gray-800 text-center mb-10">Kartu Hasil Studi (KHS)</h1>
        ...
        <div class="grid grid-cols-2 gap-6 ml-10 mb-8">
            ...
            <div>
                ...
                <div class="mb-1">
                    <label class="block text-xl font-semibold text-gray-700 mb-1">IPK (Indeks Prestasi Kumulatif)</label>
        ...
        <div class="space-y-2">
            ...
            $semesters = [
                [
                    ...
                    'sks' => 10,
                    'matakuliah' => [
                        ['kode_mk' => 'PAIK6501', 'nama_mk' => 'Pengembangan Berbasis Platform', 'sks' => '4', 'nilai' => 'A', 'bobot' => '4.00'],
                        ['kode_mk' => 'PAIK6502', 'nama_mk' => 'Komputasi Tersebar dan Paralel', 'sks' => '3', 'nilai' => 'A', 'bobot' => '4.00'],
                        ['kode_mk' => 'PAIK6503', 'nama_mk' => 'Sistem Informasi', 'sks' => '3', 'nilai' => 'A', 'bobot' => '4.00']
                    ]
                ],
                [
                    'semester' => 2, 
                    ...
                    'sks' => 9,
                    'matakuliah' => [
                        ['kode_mk' => 'PAIK6504', 'nama_mk' => 'Proyek Perangkat Lunak', 'sks' => '3', 'nilai' => 'A', 'bobot' => '4.00'],
                        ['kode_mk' => 'PAIK6505', 'nama_mk' => 'Pembelajaran Mesin', 'sks' => '3', 'nilai' => 'AB', 'bobot' => '3.50'],
                        ['kode_mk' => 'PAIK6506', 'nama_mk' => 'Keamanan Jaminan dan Informasi', 'sks' => '3', 'nilai' => 'A', 'bobot' => '4.00']
                    ]
                ],
                [
                    'semester' => 3, 
            ...
            <div class="border rounded-lg overflow-hidden">
                <button class="w-full px-6 py-4 text-left bg-white hover:bg-gray-50 focus:outline-none flex justify-between items-center" 
                    ...
                    <div class="flex items-center space-x-6">
                        <span class="text-gray-600">IP Semester: 3.85</span>
                ...
                <div class="hidden" id="semester-{{ $sem['semester'] }}-content">
                    @include('mahasiswa.khs_table', ['matakuliah' => $sem['matakuliah']])
