                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($ruangs as $ruang)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $ruang->kode_ruang }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $ruang->programStudi->nama_prodi }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $ruang->kuota }}</td>
