<nav class="fixed top-0 z-50 w-full bg-teal-600 border-b border-gray-100">
    <div class="px-1 py-1 lg:px-3 lg:pl-2">
        <div class="flex justify-between items-center">
            <div class="flex justify-start items-center rtl:justify-end">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                    type="button"
                    class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-gray-200">
